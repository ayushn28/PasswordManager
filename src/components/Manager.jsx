...
const Manager = () => {
    ...
    <>
        <ToastContainer />
        <div className="fixed inset-0 -z-10 h-screen w-screen overflow-hidden bg-green-50 
            bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] 
            bg-[size:14px_24px]">
            <div className="absolute left-0 right-0 top-0 -z-10 m-auto h-[310px] w-[310px] 
                rounded-full bg-green-400 opacity-20 blur-[100px]"></div>
        </div>

        <div className="p-3 md:mycontainer h-screen flex flex-col justify-between overflow-hidden">
            <div>
                    ...
                    <div className="flex flex-col md:flex-row w-full justify-between gap-8">
                        ...
                        <div className="relative">
                            <input ref={passwordRef} value={form.password} onChange={handleChange}
                                ...
                                className='rounded-full border border-green-500 w-full p-4 py-1' type="password" name="password" />
            ...
            <div className="passwords flex-1 overflow-y-auto mt-4 pb-10">
                <h2 className='font-bold text-2xl py-4'>Your Passwords</h2>
                {passwordArray.length === 0 && <div>No passwords to show</div>}
                {passwordArray.length !== 0 && (
                    <div className="max-h-[50vh] overflow-y-auto rounded-md shadow-md">
